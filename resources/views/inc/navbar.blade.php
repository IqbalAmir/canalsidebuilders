    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">
                {{ config('app.name', 'Canalside Builders') }}
            </a>
        </div>
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="/canalsidebuilders/public/home">Your Reviews</a></li>
                          <li><a href="/canalsidebuilders/public/orders">My Orders</a></li>
                          <li><a href="/canalsidebuilders/public/accounts">My Account</a></li>
                            <li>
                                <a href="{{ route('logout') }}"
